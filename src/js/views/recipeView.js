...
const [int,dec]=newCount.toString().split('.').map(el=>parseInt(el,10)) //ie int 2 and dec=5
...
export const renderRecipe=(receipe,isLiked)=>{
    const markup=`
...
<div class="recipe__ingredients">
    ...
    ${receipe.ingredients.map(el=>createIngredient(el)).join('')}
   </ul>
